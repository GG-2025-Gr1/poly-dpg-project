...
def get_2x2_grid_graph():
    ...
    vertices_data = [
        (1, 0.0, 0.0), (2, 1.0, 0.0), (3, 2.0, 0.0), # Rząd dolny
        (4, 0.0, 1.0), (5, 1.0, 1.0), (6, 2.0, 1.0), # Rząd środkowy
        (7, 0.0, 2.0), (8, 1.0, 2.0), (9, 2.0, 2.0)  # Rząd górny
    ]
    ...
    edges_data = [
        ...
        ('E1', 1, 2, 1), ('E2', 2, 3, 1), # Dół
        ('E3', 3, 6, 1), ('E4', 6, 9, 1), # Prawa
        ('E5', 9, 8, 1), ('E6', 8, 7, 1), # Góra
        ('E7', 7, 4, 1), ('E8', 4, 1, 1), # Lewa
        
        # Wewnętrzne (Internal B=0) - to są krawędzie współdzielone między Q
        ('E9',  4, 5, 0), # Pozioma środek (między Q1/Q3 a Q2/Q4 - nie, to między Q1 a Q3)
