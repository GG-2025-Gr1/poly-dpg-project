...
from productions.p0 import ProductionP0  # Używamy standardowego P0
...
if __name__ == '__main__':
    ...
    visualize_graph(graph, "Szesciokat jako Q - Przed P0", filename="test_hex_Q_init.png")
    ...
    visualize_graph(graph, "Szesciokat jako Q - Po P0", filename="test_hex_Q_result.png")
