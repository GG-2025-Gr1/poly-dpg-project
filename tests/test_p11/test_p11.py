...
def test_vis_error_wrong_attribute():
    ...
    visualize_graph(
        graph, "P11 Error: Q ma R=0", f"{VIS_DIR}/scenariusz4_error_zle_R.png"
    )
...
def test_vis_error_missing_edge():
    ...
    visualize_graph(
        ...
        f"{VIS_DIR}/scenariusz5_error_caly_bok.png",
    )
...
#
#     visualize_graph(
#         graph, "P11: Twisted Geometry (LHS)", f"{VIS_DIR}/scenariusz7_twisted_przed.png"
#     )
#
#     p11 = ProductionP11()
#     p11.apply(graph)
#
#     visualize_graph(
#         graph, "P11: Twisted Geometry (RHS)", f"{VIS_DIR}/scenariusz7_twisted_po.png"
#     )
#
#
...
#     visualize_graph(
#         graph,
#         "P11 Error: Label='S' zamiast 'Q'",
#         f"{VIS_DIR}/scenariusz8_error_zla_etykieta.png",
#     )
#
#     p11 = ProductionP11()
#     matches = p11.find_lhs(graph)
...
#
#     visualize_graph(
#         graph, "P11: Concave (LHS)", f"{VIS_DIR}/scenariusz9_concave_przed.png"
#     )
#
#     p11 = ProductionP11()
#     p11.apply(graph)
#
#     visualize_graph(
#         graph, "P11: Concave (RHS)", f"{VIS_DIR}/scenariusz9_concave_po.png"
#     )
#
#
...
#     visualize_graph(
#         graph,
#         "P11: Connected Neighbors (LHS)",
#         f"{VIS_DIR}/scenariusz10_connected_przed.png",
#     )
#
#     # 2. Aplikacja
#     p11 = ProductionP11()
...
#     visualize_graph(
#         graph,
#         "P11: Connected Neighbors (RHS)",
#         f"{VIS_DIR}/scenariusz10_connected_po.png",
#     )
